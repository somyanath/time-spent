...
- **Issue #1 is the parent PRD, not a work item.** Never close it or treat it as a task — use it only as reference context for the slice you are implementing. Only work on the numbered "Slice" issues.
